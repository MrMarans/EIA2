...
(function (Aufg8_Main) {
    var flowerSettings = (function () {
        ...
        flowerSettings.prototype.drawFlower = function () {
            ...
            Aufg8_Main.crc3.fillStyle = color;
            Aufg8_Main.crc3.strokeStyle = color;
            Aufg8_Main.crc3.ellipse(this.x + 0, this.y + 0, 4, 10, 0 * Math.PI / 180, 0, 2 * Math.PI);
            Aufg8_Main.crc3.ellipse(this.x + 0, this.y + 0, 4, 10, 45 * Math.PI / 180, 0, 2 * Math.PI);
            Aufg8_Main.crc3.ellipse(this.x + 0, this.y + 0, 4, 10, 90 * Math.PI / 180, 0, 2 * Math.PI);
            Aufg8_Main.crc3.ellipse(this.x + 0, this.y + 0, 4, 10, 135 * Math.PI / 180, 0, 2 * Math.PI);
            ...
            Aufg8_Main.crc3.ellipse(this.x + 0, this.y + 0, 4, 4, 0 * Math.PI / 180, 0, 2 * Math.PI);
            Aufg8_Main.crc3.closePath();
            Aufg8_Main.crc3.fill();
        };
